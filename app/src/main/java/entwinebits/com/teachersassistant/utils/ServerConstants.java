...
public class ServerConstants {
    ...
    public static final int ACTION_ADD_PAYMENT_HISTORY = 8;
    ...
    public static final String DIALING_CODE = "dc";
    public static final String PHONE_NUMBER = "phnNum";
    ...
    public static final String MONTHEND = "mnthend";
    public static final String YEAREND = "yrend";
